...
date: 2022-01-20 21:00:00-0400
description: Supplementary materials for the book "Machine Learning Fundamentals", published by Cambridge University Press.
tags: machine-learming AI

---

<div class="row">
    <div class="col-sm-3 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/mlb-book-cover-small.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

This post provides complementary materials for my recent textbook [**Machine Learning Fundamentals**](https://www.amazon.com/Machine-Learning-Fundamentals-Concise-Introduction/dp/1108940021) by [*Hui Jiang*](https://incml.github.io/huijiang/), Cambridge University Press, 2021.
